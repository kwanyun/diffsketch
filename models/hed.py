...
class Network(torch.nn.Module):
    ...
    def forward(self, tenInput):
        ...
        #modification for the style.
        return self.netCombine(torch.cat([ tenScoreOne, tenScoreTwo, tenScoreThr, tenScoreTwo, tenScoreOne ], 1))
    # end
# end
...
def estimate(tenInput):
    ...
    return 1 - netNetwork(tenInput.cuda().view(1, 3, intHeight, intWidth))
